...
import com.turkcell.trex.TrexSampleApplicationApp;
...
@SpringBootTest(classes = TrexSampleApplicationApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class TrexSampleApplicationKafkaResourceIT {
    ...
    @Autowired
    private TrexSampleApplicationKafkaProducer producer;

    @Autowired
    private TrexSampleApplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        TrexSampleApplicationKafkaResource kafkaResource = new TrexSampleApplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/trex-sample-application-kafka/publish?message=test"))
